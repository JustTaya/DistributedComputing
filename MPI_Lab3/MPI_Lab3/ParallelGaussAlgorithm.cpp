...
double ParallelGaussAlgorithm::execute(int argc, char* argv[])
{
...
void ParallelGaussAlgorithm::DataDistribution(double* pMatrix, double* pProcRows, double* pVector, double* pProcVector, int Size, int RowNum)
{
...
void ParallelGaussAlgorithm::ResultCollection(double* pProcResult, double* pResult)
{
