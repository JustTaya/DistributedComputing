...
double HorisontalStripesAlgorithm::execute(int argc, char* argv[])
{
...
void HorisontalStripesAlgorithm::DataDistribution(double* pMatrix, double* pProcRows, double* pVector, int Size,
...
void HorisontalStripesAlgorithm::ParallelResultCalculation(double* pProcRows, double* pVector, double* pProcResult, int Size,
    int RowNum) {
    int i, j;
    for (i = 0; i < RowNum; i++) {
        pProcResult[i] = 0;
...
void HorisontalStripesAlgorithm::ProcessInitialization(double*& pMatrix, double*& pVector, double*& pResult,
...
void HorisontalStripesAlgorithm::ProcessTermination(double* pMatrix, double* pVector, double* pResult,
...
void HorisontalStripesAlgorithm::RandomDataInitialization(double*& pMatrix, double*& pVector, int& Size) {
    int i, j;
...
void HorisontalStripesAlgorithm::ResultReplication(double* pProcResult, double* pResult, int Size, int RowNum, int ProcNum, int ProcRank) {
    int i;
